...
$gshock_sql = "SELECT i.id, i.image_path, i.product_name, i.description, i.price, i.category_id FROM items i WHERE i.category_id = 2 ORDER BY price";
$result = mysqli_query($conn, $gshock_sql);
