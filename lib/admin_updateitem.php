	...
	if (in_array($fileActualExt, $allowed)) {
		...
		if ($fileError === 0) {
			...
			if ($fileSize < 5000000) {
				...
				$updateitem_qry = "UPDATE items SET product_name = '$product_name', description = '$description', price = '$price', category_id = '$category', image_path = '$image_path' WHERE id = '$item_id'";
